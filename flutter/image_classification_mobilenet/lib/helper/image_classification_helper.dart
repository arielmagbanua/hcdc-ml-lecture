...
class ImageClassificationHelper {
  // TODO: change to your model accordingly
  // static const modelPath = 'assets/models/mobilenet_quant.tflite';
  // static const labelsPath = 'assets/models/labels.txt';
  static const modelPath = 'assets/models/snacks_classifier.tflite';
  static const labelsPath = 'assets/models/snacks_labels.txt';
  ...
  Future<void> _loadModel() async {
    ...
    // Use GPU Delegate
    if (Platform.isAndroid && await SafeDevice.isRealDevice) {
